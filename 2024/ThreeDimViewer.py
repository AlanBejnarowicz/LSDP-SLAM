...
class ThreeDimViewer:
    ...
    def __init__(self):
        ...
        self.vertices: list[tuple[numeric, numeric, numeric]] = []
        self.colors: list[tuple[numeric, numeric, numeric]] = []
        self.cameras = []
    ...
    def rotate_camera_based_on_key_inputs(self):
        keypress = pygame.key.get_pressed()
        rotate_scale = 0.2
        if keypress[pygame.K_LCTRL]:
            if keypress[pygame.K_w]:
                gl.glRotatef(rotate_scale, 1, 0, 0)
            if keypress[pygame.K_s]:
                gl.glRotatef(-rotate_scale, 1, 0, 0)
            if keypress[pygame.K_d]:
                gl.glRotatef(rotate_scale, 0, 1, 0)
            if keypress[pygame.K_a]:
                gl.glRotatef(-rotate_scale, 0, 1, 0)
            if keypress[pygame.K_q]:
                gl.glRotatef(rotate_scale, 0, 0, 1)
